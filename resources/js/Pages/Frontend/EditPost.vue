    ...
    <div class="min-h-screen bg-amber-50 py-16 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-12">
                <h1 class="text-6xl font-extrabold text-stone-800 mb-4">Edit Post</h1>
                <p class="text-stone-600 text-xl">Refine and update your content ✏️</p>
            </div>
...
const submit = () => {
    ...
    })).put(route("posts.update", props.post.id));
};
</script>
